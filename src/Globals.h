...
extern float MQTT_TEMP_VALUE;
extern bool MQTT_TEMP_AVAILABLE;
extern bool TIME_CAL_TEMP_TOGGLE;
extern uint32_t TEMP_BOX_COLOR_COLD;
extern uint32_t TEMP_BOX_COLOR_WARM;
extern uint32_t TEMP_BOX_TEXT_COLOR;
